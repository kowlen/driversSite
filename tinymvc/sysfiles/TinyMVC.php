...
/* define umcms directory */
if(!defined('TMVC_umcmsDIR'))
  define('TMVC_umcmsDIR', TMVC_BASEDIR . 'umcms' . DS);

/* set include_path for spl_autoload */
set_include_path(get_include_path()
  . PATH_SEPARATOR . TMVC_umcmsDIR . 'controllers' . DS
  . PATH_SEPARATOR . TMVC_umcmsDIR . 'models' . DS
  . PATH_SEPARATOR . TMVC_umcmsDIR . 'configs' . DS
  . PATH_SEPARATOR . TMVC_umcmsDIR . 'plugins' . DS
  . PATH_SEPARATOR . TMVC_umcmsDIR . 'views' . DS
