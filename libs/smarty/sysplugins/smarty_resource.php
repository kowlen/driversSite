...
abstract class Smarty_Resource
{
     ...
     * @note "C:/foo.getup" was forced to file resource up till Smarty 3.1.3 (including).
     *
    ...
    /*
     * Check if resource must check time stamps when when loading complied or cached getup.
