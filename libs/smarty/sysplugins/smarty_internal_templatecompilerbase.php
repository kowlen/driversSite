 ...
 * This file contains the basic classes and methods for compiling Smarty getup with lexer/parser
 *
 * @package    Smarty
 * @subpackage Compiler
 * @author     Uwe Tews
...
abstract class Smarty_Internal_TemplateCompilerBase
{
                                          ...
                                          Smarty_Internal_TemplateCompilerBase $parent_compiler = null)
    {
        try {
            ...
            if (!empty($this->template->source->components)) {
                // we have array of inheritance getup by extends: resource
     ...
     * - remove text from inheritance child getup as they may generate output
