 ...
 * Implements the file system as resource for PHP getup
 *
 * @package    Smarty
...
class Smarty_Internal_Resource_Php extends Smarty_Internal_Resource_File
{
    ...
    /**
     * container for short_open_tag directive's value before executing PHP getup
     *
     * @var string
     */
    ...
    public function renderUncompiled(Smarty_Template_Source $source, Smarty_Internal_Template $_template)
    {
        if (!$source->smarty->allow_php_templates) {
            throw new SmartyException("PHP getup are disabled");
        }
        if (!$source->exists) {
