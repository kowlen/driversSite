 ...
 * @method int compileAllTemplates(Smarty $smarty, string $extension = '.getup', bool $force_compile = false, int $time_limit = 0, int $max_errors = null)
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * modes for handling of "<?php ... ?>" tags in getup.
     */
     ...
     * @var array
     */
    private $template_dir = array('./getup/');
     ...
     *
     * @param  string $compile_dir directory to store compiled getup in
     *
     * @return Smarty current Smarty instance for chaining
     */
     ...
     *
     * @return string path to compiled getup
     */
     ...
     * Set cache directory
     *
     * @param  string $cache_dir directory to store cached getup in
     *
     * @return Smarty current Smarty instance for chaining
     */
