...
class PHPExcel_Writer_Excel2007_ContentTypes extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    public function writeContentTypes(PHPExcel $pPHPExcel = null, $includeCharts = false)
    {
        ...
        if ($pPHPExcel->hasMacros()) { //Macros in workbook ?
            ...
            $this->writeOverrideContentType($objWriter, '/xl/workbook.xml', 'application/vnd.ms-excel.sheet.macroEnabled.default+xml');
            ...
            $this->writeOverrideContentType($objWriter, '/xl/workbook.xml', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet.default+xml');
        }
